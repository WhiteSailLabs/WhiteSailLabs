...
> **我的 FDE Build Lab 项目 · 调研与方案阶段。** 我使用公开设备手册、合成异常记录和可复现实验完成项目；从问题定义、数据构造、系统实现到评估均由我负责。
...
我把项目限定在一个个人能够真正完成和证明的范围：选择一类有公开手册的工业设备，构造“标准操作 + 现场异常 + 专家判断”三层知识，验证知识如何从零散资料进入可检索、可训练、可追踪的工作流程。第一阶段不假设存在真实工厂客户，所有角色、任务与异常都通过公开资料和合成数据建立。
...
这里最关键的 FDE 动作，是把调研问题直接变成后面的评估集。我的项目会先运行基线，再根据真实测试结果制定验收阈值，不预写漂亮数字。
...
这是我的公开 Build Lab 项目。我负责范围定义、数据构造、系统实现、评估设计、失败记录和最终结论；没有真实企业数据时使用公开与合成数据，并持续公开项目当前阶段。
